...
def colonne_basse(image:str or list):
...
##----- Test reduction moitie(). -----

print("Test de moitie() :")
moitieTest = [1] * 6
print("La 'moitié' de", moitieTest, "est", moitie(moitieTest))
print("Ceci est correct" if moitie(moitieTest) == [1] * 3 else "Something went wrong")
print("-"*50)
...
print("Test de energie() :")
im_e = energie(f"{image}")
plt.imshow(im_e, cmap = 'gray', clim = (0, 255))
plt.show()
print("-"*50)

##----- Test energie_min(). -----

print("Test de energie_min() :")
listeTest = [2, 3, 1, 4] # cette ligne peut être modifiée pour tester d'autres listes
print(f"Vérifions cette fonction sur la liste suivante {listeTest}")
listeTraitée, rg = energie_min(listeTest)
print("La liste traitée est alors :", listeTraitée, "et le rang dans la liste de départ de l'élément supprimée est :", rg)
liste2, rgTest = listeTest, listeTest.index(min(listeTest))
liste2.pop(rgTest)
print("Ceci est correct" if listeTraitée == liste2 and rg == rgTest else "Something went wrong")
print("-"*50)
...
print("Test de colonne_basse() :")
liste_ac = [[2, 3, 1, 4], [2, 3, 1, 4]]
colonne_b = colonne_basse(liste_ac)
print("La colonne de plus basse énergie dans", liste_ac, "est la colonne", colonne_b)
print("Ceci est correct" if colonne_b == 1 else "Something went wrong")
print("-"*50)


##----- Test reduction_colonne(). -----
